<?php
    ...
    $sql = "SELECT id_product, name, price, description, file_path, photo_path FROM products WHERE id_product = $id_product;";
...
<head>
    ...
    <link rel="stylesheet" href="../responsive/edit_edit_product.css">
</head>
<body>
<header>
...
<main>
<form action="../scripts/edit_product_sc.php" method="post">
        <input type="number" name="id_product" value="<?php echo $id_product; ?>" hidden>
        <label for="product_name">Product name:</label>
        <input type="text" id="product_name" name="product_name" value="<?php echo $name; ?>">
        <label for="product_price">Product price:</label>
        <input type="number" id="product_price" name="product_price" value="<?php echo $price; ?>">
        <label for="product_description">Product description:</label>
        <textarea id="product_description" name="product_description"><?php echo $description; ?></textarea>
